                            ...
                            <?php foreach ($jobPosts as $post): ?>
                                <tr class="job-row" id="job-<?= $post['id'] ?>">
                                    ...
                                    <td class="job-actions">
                                        <br><a href="view_job_post.php?id=<?= $post['id'] ?>" class="btn btn-primary" style="margin-left:300px;">
                                            View Details
                                        </a>
                                        <a href="message.php?job_id=<?= $post['id'] ?>" class="btn btn-primary" id="messages-link" style="margin-left: 10px;">
                                            Messages
                                        </a>
                                        <form action="hr_dashboard.php" method="POST" class="delete-form" style="display: inline;">
                                            ...
                                            <button type="submit" name="delete_job_post" class="btn btn-danger"
